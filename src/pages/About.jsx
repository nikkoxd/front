          ...
          <div className="advantages_right">
            <div className="advantages_item">
              ...
              <div className="advantages_item_text">
                Возможность открытия производства вблизи крупнейшего в мире производителя
                титана ПАО «Корпорация ВСМПО-АВИСМА»
              </div>
            </div>
            <div className="advantages_item">
              <div className="advantages_item_title">
              ...
              <div className="advantages_item_text">
                Возможность осуществить пуск производства в сжатые сроки
              </div>
            </div>
            <div className="advantages_item">
              <div className="advantages_item_title">
              ...
              <div className="advantages_item_text">
                Возможность снижения затрат на 30%
              </div>
            </div>
            <div className="advantages_item">
              <div className="advantages_item_title">
              ...
              <div className="advantages_item_text">
                Возможность укомплектовать производство квалифицированным производственным
                и обслуживающим персоналом в согласованные сроки
              </div>
            </div>
            <div className="advantages_item">
              <div className="advantages_item_title">
              ...
              <div className="advantages_item_text">
                Возможность использовать подъездной железнодорожный путь и контейнерную
                площадку
              </div>
            </div>
          </div>
        ...
        <div className="development_list">
          <div className="development_card">
            ...
            <div className="development_card_text">
              <p>
                Repudiandae earum vitae mollitia. Veritatis deleniti est quidem explicabo fugiat possimus. Qui alias accusantium corrupti ea nobis aperiam. Rerum enim iste tempore a.
                Voluptatem sed ut accusantium et. Cum in sequi dolorem illo. Et exercitationem ut omnis consequatur.
              </p>
              <div className="development_card_button">
                <Link to="#" className="button">Подробнее</Link>
              </div>
            </div>
          </div>
          <div className="development_card">
